...
# num_d2, den_d2, td = cont2discrete((filter_sense.num, filter_sense.den), Tsampling, method='euler')

# #normalizo con dlti
# filter_d2 = dlti(num_d2, den_d2)
# print ('Filtro Digital sys 2')
# print (str(filter_d2.num), '/(', str(filter_d2.den), ')')
