...
"""
        Same as 01 but voltage output as seen by the ADC
...
Plant_out = Vpwm * Zout_load * adc_multiplier
...
if show_digital_open_loop_bode:
    ...
    ax1.semilogx(w/(2*np.pi), mag_ol, 'b')
    ax1.set_title('Digital OpenLoop Blue')
    ax1.set_ylabel('Amplitude P D2 [dB]', color='b')
    ax1.set_xlabel('Frequency [Hz]')
    # ax1.set_ylim([-40, 40])
